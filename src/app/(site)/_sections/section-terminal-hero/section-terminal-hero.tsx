...
export interface SectionTerminalHeroProps extends Omit<TerminalSectionProps, "children"> {
  name: string;
  role: string;
}
  ...
  return (
    <TerminalSection title={title} ariaLabel={ariaLabel} isHero>
      <p className={styles.line}>
        <span className={styles.strong}>{name}</span> — <span className={styles.role}>{role}</span>
      </p>
    </TerminalSection>
  );
}
